...
public class Personaje implements IPersonaje {
    ...
    public void info() {
        ...
        if (!armas.isEmpty()) {
            ...
            System.out.println("No cuenta con armamento");
        }
        System.out.println("Porcentaje de armadura: " + porcentajeArmadura);
        System.out.println("Nivel Defensa: " + puntosDefensa);
        System.out.println("Nivel Ataque: " + puntosAtaque);
        System.out.println("Nivel Regeneracion: " + puntosRegeneracion);
    }
